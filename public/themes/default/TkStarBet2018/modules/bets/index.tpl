						...
						<li>
							...
							<div class="col-lg-6">
								...
								<div class="main-splash" data="0">
									<div class="image-container" style="height: 400px !important; margin-top: 8px !important;">
										<div class="image" style="background-image: url({assets_url}/images/slider/betting.jpg); margin-left: 0%;"></div>
							...
							<div class="col-lg-3">
								<div style="margin-top: 10px !important;">
									...
									<p><a href="http://telegram.me/change_rate">
									<img border="0" src="http://uupload.ir/files/1csw_pfm.png" width="308" height="225"></a></p>
