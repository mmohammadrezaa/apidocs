						...
						<div class="p30 inline" align="right" style="margin-top: -30px !important; text-align: right !important; width: 100% !important;">
							...
							<div class="mt15">
								...
								<div class="left form-element" style="text-align: right !important;">
									<a class="btn form-button btn-block" href="{site_url}users/resetPassword">کلمه عبور خود را فراموش کرده ام !</a>
									<a class="btn form-button btn-block" href="{site_url}users/register">ساخت حساب کاربری جدید</a>
								</div>
								<div class="clear"></div>
							</div>
						</div>
