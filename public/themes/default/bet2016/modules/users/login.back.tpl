        ...
        <div class="modal-content">
            <form action="{site_url()|con:'users/resetPassword'}" method="POST" id="forgotpass-form">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">   <i class="fa fa-user" aria-hidden="true"></i> بازیابی رمز عبور</h4>
                </div>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-default pull-left">بازیابی رمز عبور</button>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="entry-header">
                    <h1 class="entry-title">حساب کاربری من</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-fields rtl">
                    <h2><i class="fa fa-user" aria-hidden="true"></i> ورود به حساب کاربری</h2>
                    <p>
                ...
                <div class="form-action">
                    <p class="lost_password"><a class="btn" data-toggle="modal" data-backdrop="true" data-keyboard="true" href="#forgotModal">کلمه عبور خود را فراموش کرده اید؟</a></p>
                    <input type="submit" value="ورود" />
                    <label><input type="checkbox" name="remember_me" value="1"/>  منو به خاطر بسپار </label>
                </div>
                {form_close()}
            </div>
